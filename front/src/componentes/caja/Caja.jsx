...
const Caja = () => {
    ...
    //const API_BASE_URL = 'http://localhost/ELCUMPA/public'; // Cambia por la URL real de tu backend
    const API_BASE_URL = 'http://localhost/LARAVEL/ELCUMPA/RestauranteCumpa/public';
